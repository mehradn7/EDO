function [ log_err_x1, log_err_x2 ] = calcul_erreur(methode, nb_appels_phi, handler_phi, intervalle_tps,y0)
t0 = intervalle_tps(1);
tf = intervalle_tps(2);
...
for N=1:length(log_nfe)
   [~,Y] = methode(handler_phi,[t0 tf],y0,abscisses_evals(N)/ nb_appels_phi);
